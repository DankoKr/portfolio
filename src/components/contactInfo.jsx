    ...
    >
      {contactMethods.map((method, index) => (
        ...
        >
          ...
          <p className="text-m text-gray-300 mb-6">{method.value}</p>
          <a
            href={method.href}
            target="_blank"
            rel="noopener noreferrer"
            className="w-full bg-[#1a3a4a] hover:bg-[#254b5e] text-white py-2 rounded-md text-m text-center transition-colors"
          >
            Connect
          </a>
        </motion.div>
